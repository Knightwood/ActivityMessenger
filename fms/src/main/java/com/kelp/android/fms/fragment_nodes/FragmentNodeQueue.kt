package com.kelp.android.fms.fragment_nodes

import androidx.fragment.app.Fragment
import com.kelp.android.fms.fragment_nodes.FragmentNode.FragmentNodeBuilder
import java.util.LinkedList
import java.util.Queue

/**
 * fragment node 队列。存储所有fragment节点。
 */
class FragmentNodeQueue {
    ...
    fun findTop(tag: String? = null): FragmentNode? {
        val founded: FragmentNode? = stack.peek()
        if (tag == null) {
            return founded
        } else

package com.kelp.android.fms.runtime.nav_options
...
fun navOptions(
    attachTo: INavController,
    block: NavOptions.() -> Unit
): NavOptions {
    val navOptions = NavOptions(attachTo)
...
data class NavOptions(
    ...
    val isUseReplace: Boolean = false
